...
<svg
	...
	style="enable-background:new 0 0 232.914 232.914;"
	xml:space="preserve"
	fill="{color}"
	width="{width}"
>
	<title>Upload audio sound</title>
	<g>
		<path
			d="M9,64.099c-4.971,0-9,4.029-9,9v86.716c0,4.971,4.029,9,9,9s9-4.029,9-9V73.099C18,68.128,13.971,64.099,9,64.099z"
		/>
		<path
